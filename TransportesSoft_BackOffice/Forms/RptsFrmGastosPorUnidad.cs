    ...
    public partial class RptsFrmGastosPorUnidad : Base
    {
        ...
        private void BtnImprimir_Click(object sender, EventArgs e)
        {
            ...
            if (ValidarFechas(fechaInicial, fechaFinal))
            {
                ...
                FormReporte lreport = new FormReporte(FormReporte.TipoReporte.GastosPorUnidad, fechaInicial, fechaFinal, idUnidad);
